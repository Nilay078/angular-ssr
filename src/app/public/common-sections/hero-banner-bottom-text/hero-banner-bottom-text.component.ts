...
@Component({
    selector: 'app-hero-banner-bottom-text',
    templateUrl: './hero-banner-bottom-text.component.html',
    styleUrls: ['./hero-banner-bottom-text.component.scss'],
    providers: [HomeService],
})
export class HeroBannerBottomTextComponent implements OnInit {
    @Input() data: any;
